...
<div class="col-12 col-md-12 p-3 p-md-5">
  ...
  <ol class="breadcrumb p-2">
			 <li class="breadcrumb-item">
				<a class="text-secondary" href="<?php get_site_url(); ?>">Home</a> </li>
				<li class="breadcrumb-item">
				<?php Innovation_Parent_Link(get_parent(FALSE)); ?> <b><?php get_page_clean_title(); ?></b>
				</li> 
				<li class="breadcrumb-item"><a class="text-secondary" href="<?php get_site_url(); ?>" id="logo" ><?php get_site_name(); ?></a></li>
			</ol></nav>
